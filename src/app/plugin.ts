...
import { LocalEmbeddingProvider, buildVectorIndex, getEmbeddingIdentity, DEFAULT_LOCAL_MODEL, normalizeRemoteHost, type EmbeddingProvider, type IndexPlugin } from "@semantic/embedding";
